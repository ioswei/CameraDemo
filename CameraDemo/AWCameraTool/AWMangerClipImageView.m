...
typedef NS_ENUM(NSInteger, AWCropAreaCornerPosition) {
    AWCropAreaCornerPositionTopLeft,
    AWCropAreaCornerPositionTopRight,
    AWCropAreaCornerPositionBottomLeft,
    AWCropAreaCornerPositionBottomRight
};
typedef NS_ENUM(NSInteger, AWMidLineType) {
...
#pragma mark ===== AWHandler
@interface UIImage(AWHandler)

@end

@implementation UIImage(AWHandler)
...
#pragma mark ===== AWCornerView

@interface AWCornerView: UIView

@property (assign, nonatomic) CGFloat lineWidth;
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) AWCropAreaCornerPosition cornerPosition;
@property (assign, nonatomic) AWCornerView *relativeViewX;
@property (assign, nonatomic) AWCornerView *relativeViewY;
@property (strong, nonatomic) CAShapeLayer *cornerShapeLayer;

- (void)updateSizeWithWidth: (CGFloat)width height: (CGFloat)height;
@end

@implementation AWCornerView
...
- (void)setCornerPosition:(AWCropAreaCornerPosition)cornerPosition {
...
- (void)drawCornerLines {
    ...
    switch (_cornerPosition) {
        case AWCropAreaCornerPositionTopLeft: {
        ...
        case AWCropAreaCornerPositionTopRight: {
        ...
        case AWCropAreaCornerPositionBottomLeft: {
        ...
        case AWCropAreaCornerPositionBottomRight: {
...
@interface AWMangerClipImageView ()
...
#pragma mark ====== AWMidLineView

@interface AWMidLineView : UIView
@property (strong, nonatomic) CAShapeLayer *lineLayer;
@property (assign, nonatomic) CGFloat lineWidth;
@property (assign, nonatomic) CGFloat lineHeight;
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) AWMidLineType type;
@end

@implementation AWMidLineView
...
- (void)setType:(AWMidLineType)type {
...
- (void)drawMidLine {
    ...
    switch (_type) {
        case AWMidLineTypeTop:
        case AWMidLineTypeBottom: {
        ...
        case AWMidLineTypeRight:
        case AWMidLineTypeLeft: {
...
#pragma mark ==== AWCropAreaView

@interface AWCropAreaView : UIView
...
@property (strong, nonatomic) AWCornerView *topLeftCorner;
@property (strong, nonatomic) AWCornerView *topRightCorner;
@property (strong, nonatomic) AWCornerView *bottomLeftCorner;
@property (strong, nonatomic) AWCornerView *bottomRightCorner;
@property (strong, nonatomic) AWCropAreaView *cropAreaView;
...
@property (strong, nonatomic) AWMidLineView *topMidLine;
@property (strong, nonatomic) AWMidLineView *leftMidLine;
@property (strong, nonatomic) AWMidLineView *bottomMidLine;
@property (strong, nonatomic) AWMidLineView *rightMidLine;
...
@implementation AWMangerClipImageView
...
- (void)setUp {
    ...
    _cropAreaView = [[AWCropAreaView alloc] init];
...
- (void)handleMidPan: (UIPanGestureRecognizer *)panGesture {
    ...
    AWMidLineView *midLineView = (AWMidLineView *)panGesture.view;
    switch (panGesture.state) {
        case UIGestureRecognizerStateBegan: {
...
- (void)handleCornerPan: (UIPanGestureRecognizer *)panGesture {
    ...
    AWCornerView *panView = (AWCornerView *)panGesture.view;
    AWCornerView *relativeViewX = panView.relativeViewX;
    AWCornerView *relativeViewY = panView.relativeViewY;
...
- (void)createCorners {
    _topLeftCorner = [[AWCornerView alloc]initWithFrame: CGRectMake(0, 0, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor:_cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _topLeftCorner.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleRightMargin;
    _topLeftCorner.cornerPosition = AWCropAreaCornerPositionTopLeft;
    
    _topRightCorner = [[AWCornerView alloc]initWithFrame: CGRectMake(WIDTH(_imageView) -  _cropAreaCornerWidth, 0, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _topRightCorner.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin;
    _topRightCorner.cornerPosition = AWCropAreaCornerPositionTopRight;
    
    _bottomLeftCorner = [[AWCornerView alloc]initWithFrame: CGRectMake(0, HEIGHT(_imageView) -  _cropAreaCornerHeight, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _bottomLeftCorner.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleRightMargin;
    _bottomLeftCorner.cornerPosition = AWCropAreaCornerPositionBottomLeft;
    
    _bottomRightCorner = [[AWCornerView alloc]initWithFrame: CGRectMake(WIDTH(_imageView) - _cropAreaCornerWidth, HEIGHT(_imageView) -  _cropAreaCornerHeight, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _bottomRightCorner.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin;
    _bottomRightCorner.cornerPosition = AWCropAreaCornerPositionBottomRight;
...
- (void)createMidLines {
    ...
    _topMidLine = [[AWMidLineView alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _topMidLine.type = AWMidLineTypeTop;
    
    _bottomMidLine = [[AWMidLineView alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _bottomMidLine.type = AWMidLineTypeBottom;
    
    _leftMidLine = [[AWMidLineView alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _leftMidLine.type = AWMidLineTypeLeft;
    
    _rightMidLine = [[AWMidLineView alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _rightMidLine.type = AWMidLineTypeRight;
